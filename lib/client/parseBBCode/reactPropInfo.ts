/**
 * An object that maps HTML/SVG attribute names to their respective React prop names, excluding event listeners and reserved props.
 *
 ...
 */
export const possibleStandardNames: Partial<Record<string, string>> = {
	// HTML attributes.
	'accept': 'accept',
...
/**
 * An object mapping the prop name of each boolean attribute to `true`. If a prop name does not represent a boolean attribute, it is not in this object's keys.
 *

...
export const TAG_OR_EXCLUDED_TAG = /^-?[a-z0-9](?:[a-z0-9-]{0,48}[a-z0-9])?$/;
...
const storyTags: Partial<Record<TagString, string>> = {
	...
	suggestions: 'This adventure depends mainly on suggestions from readers.',
	mirror: 'This adventure is authored by someone else and was not intended for MSPFA.',
	resource: 'This adventure is a resource (such as a guide, asset collection, or JS/CSS module) and not a story.',
